...
_WRITE_SKILL = AdvertisedSkill(
    ...
    description=(
        ...
        "resolved or closed (issues); create issue actions from an SOP/policy, "
        "update an action, mark an action completed, and add a comment to an action "
        "(actions); and author a new SOP, update "
